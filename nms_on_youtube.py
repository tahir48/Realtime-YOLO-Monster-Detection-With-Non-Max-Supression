...
class_labels = ["Zombie","Armored","Immolator","Crowl","Hive","Hellhound"]
class_colors = [[0,255,255],[255,0,255],[255,255,0],[0,127,127],[0,255,127],[127,127,127]]
yolo_model = cv2.dnn.readNetFromDarknet('C:/Users/Lenovo/Desktop/realtime_hunt/hunt_yolov4.cfg','C:/Users/Lenovo/Desktop/realtime_hunt/hunt_yolov4_last.weights')
yolo_layers = yolo_model.getLayerNames()
yolo_output_layer = [yolo_layers[yolo_layer - 1] for yolo_layer in yolo_model.getUnconnectedOutLayers()]

while True:
    grabbed, img_to_detect = capture.read()
    frame = np.array(img_to_detect)
